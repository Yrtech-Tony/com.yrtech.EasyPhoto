...
namespace XHX
{
    public partial class MainForm : XtraForm
    {
        ...
        localhost.Service localService = new XHX.localhost.Service();
        ...
        void CreateBizMenuList()
        {
            ...
            mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("清单导入", null, new EventHandler(menu_Click)); subMenu.Tag = "ShopVinList";
            mainMenu.DropDownItems.Add(subMenu);
            ...
            //mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("下载数据", null, new EventHandler(menu_Click)); subMenu.Tag = "PadToDB";
            mainMenu.DropDownItems.Add(subMenu);
            //subMenu = new ToolStripMenuItem("生成确认单", null, new EventHandler(menu_Click)); subMenu.Tag = "SingleShopReport";
            //mainMenu.DropDownItems.Add(subMenu);
            ms.Items.Add(mainMenu);


            mainMenu = new ToolStripMenuItem("复审");
            //subMenu = new ToolStripMenuItem("照片类", null, new EventHandler(menu_Click)); subMenu.Tag = "AnswerRecheck";
            //mainMenu.DropDownItems.Add(subMenu);
            ...
            //mainMenu.DropDownItems.Add(subMenu);
            //subMenu = new ToolStripMenuItem("终审", null, new EventHandler(menu_Click)); subMenu.Tag = "AnswerRecheckLastMst";
            //mainMenu.DropDownItems.Add(subMenu);
            ms.Items.Add(mainMenu);
            ...
            //mainMenu.DropDownItems.Add(subMenu);
            //mainMenu.DropDownItems.Add(subMenu);
            //subMenu = new ToolStripMenuItem("标准查询", null, new EventHandler(menu_Click)); subMenu.Tag = "StandardSearch";
            //mainMenu.DropDownItems.Add(subMenu);
            ...
            //mainMenu.DropDownItems.Add(subMenu);
            //subMenu = new ToolStripMenuItem("得分修改记录查询", null, new EventHandler(menu_Click)); subMenu.Tag = "AnswerScoreLog";
            //mainMenu.DropDownItems.Add(subMenu);
            ...
            //mainMenu.DropDownItems.Add(subMenu);
            //subMenu = new ToolStripMenuItem("单店报告生成", null, new EventHandler(menu_Click)); subMenu.Tag = "SingleShopReport1";
            //mainMenu.DropDownItems.Add(subMenu);
            ...
            else
            {
                ...
                DataSet ds = localService.SearchCurrentUserProgram(_userInfoDto.RoleType);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
        ...
        void menu_Click(object sender, EventArgs e)
        {
            ...
            Assembly asmb = Assembly.Load("com.yrtech.easyPhoto");
